...
<!-- End Google Tag Manager (noscript) -->
    ...
    <container>
        <img class='top' src="img/stalkfinder-2.png" />

        <div class="row">
            <div>        
                <h2 id='headline'>Text your name and town<br>to find out who is stalking you?</h2>
