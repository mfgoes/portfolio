        ...
        <div class="row">
            <div>        
                <form id="askbongo-form">
                    <input type="text" id='fullname' name="firstname" class="txt" placeholder="Full Name" required>
                    <input type="text" id='location' name="location" class="txt" placeholder="Town" required>
