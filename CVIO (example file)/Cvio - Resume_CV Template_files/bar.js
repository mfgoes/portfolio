( function( $ ) {
	...
	$('.theme_panel .layout_style').on('click', 'a', function(){
		...
		if(!$('#demo_layout_css').length) {
			$('head').append('<link rel="stylesheet" id="demo_layout_css" href="https://bslthemes.com/cvio/demo/css/theme-colors/'+color+'.css" />');
		}
		else {
			$('#demo_layout_css').attr('href', 'https://bslthemes.com/cvio/demo/css/theme-colors/'+color+'.css');
		}
